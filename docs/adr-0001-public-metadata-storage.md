...
## Contexto
O CommX armazena tipos de conteudo, campos personalizados e entradas por organizacao. A necessidade inicial e ter persistencia simples, multi-tenant e com baixo overhead operacional.
